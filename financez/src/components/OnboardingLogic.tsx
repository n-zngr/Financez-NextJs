...
const OnboardingLogic = () => {
    ...
    return (
        <div className='relative h-screen w-screen overflow-hidden'>
            ...
            <div className={`absolute inset-0 transition-transform duration-600 ease-in-out ${currentPage === 5 ? 'translate-x-0' : currentPage < 5 ? 'translate-x-full' : '-translate-x-full'}`}>
